...
Original file is located at
    https://colab.research.google.com/drive/1OMBs1sjWc-xAnWcKNMz6cGMDJuvkiqJ4
"""

# 🎨 Generative Abstract Poster Practice Week2（He Pengwei）
...
def draw_poster(n_blobs, blob_radius_range, wobble_range, alpha_range, seed):
    ...
    plt.text(
        0.05, 0.91, "Week 2 • Arts & Advanced Big Data",
...
# Streamlit UI
# -----------------------------
st.title("🎨 Generative Abstract Poster Practice Week2（He Pengwei）")
